  ...
  var e = (function (e) {
    ...
    a.prototype._updateGlobalTransformMatrix = function (e) {
      ...
      if (f) {
        ...
        var c = m
          ? l._getGlobalTransformMatrix(r.x, r.y)
...
(function (t) {
  var e = (function (t) {
    ...
    e.prototype.init = function (e, a) {
      ...
      var i = e.segmentY;
      var n =
        this._armature.armatureData.parent.intArray[e.geometry.offset + 0];
      var s = 1e3;
      var o = 200;
      this._dX = (o * 2) / r;
      this._dY = (o * 2) / i;
    ...
    e.prototype.update = function (t) {
      if (t >= 0 && this._cachedFrameIndices !== null) {
        ...
        if (a >= 0 && this._cachedFrameIndex === a) {
          ...
          if (this._hasConstraint) {
            for (
              var r = 0, i = this._armature._constraints;
              r < i.length;
              r++
            ) {
              var n = i[r];
        ...
        if (this._geometryData !== a) {
          ...
          if (this._geometryData !== null) {
            ...
            if (this._geometryData.weight !== null) {
              for (
                var m = 0, p = this._geometryData.weight.bones.length;
                m < p;
                ++m
              ) {
                var c = this._armature.getBone(
                  this._geometryData.weight.bones[m].name
                );
...
(function (t) {
  ...
  var a = (function (e) {
    ...
    a.prototype._computeB = function () {
      ...
      n.rotation =
        ...
        c -
        d +
        t.Transform.normalizeRadian(F - M - c) * this._weight;
      n.toMatrix(s);
    };
    a.prototype.init = function (t, e) {
  ...
  var r = (function (e) {
    ...
    a.prototype.addCurvePosition = function (
      t,
      e,
      a,
      r,
    ...
    a.prototype.update = function () {
      ...
      if (
        e._geometryData === null ||
        e._geometryData.offset !== this.pathOffset
      ) {
        return;
      }
      var a = this._constraintData;
      ...
      this._computeBezierCurve(
        e._displayFrame.rawDisplayData,
        _,
        u,
        i === 1,
        n === 2
    ...
    a.prototype.playConfig = function (e) {
      ...
      if (this._animationStates.length > 0) {
        ...
        for (var h = 0, u = this._animationStates.length; h < u; ++h) {
          if (o.layer > this._animationStates[h].layer) {
            ...
            h !== u - 1 &&
            o.layer > this._animationStates[h + 1].layer
          ) {
            l = true;
      ...
      for (var f = 0, _ = this._armature.getSlots(); f < _.length; f++) {
        ...
        if (
          p !== null &&
          p.inheritAnimation &&
          p.animation.hasAnimation(a) &&
          p.animation.getState(a) === null
        ) {
        ...
        for (var e = 0, a = this._armature._constraints; e < a.length; e++) {
          ...
          if (i !== null) {
            for (var n = 0, s = i; n < s.length; n++) {
              ...
              switch (o.type) {
                case 30: {
                  var l = t.BaseObject.borrowObject(
    ...
    r.prototype._updateBoneAndSlotTimelines = function () {
      {
        ...
        for (var h = 0, u = this._armature.getBones(); h < u.length; h++) {
          ...
          if (s in e) {
            ...
            var m = this._armature.animation.getBlendState(
              a.BONE_TRANSFORM,
              f.name,
              f
            );
              ...
              for (var p = 0, c = _; p < c.length; p++) {
                ...
                switch (d.type) {
                  ...
                  case 60: {
                    ...
                    n.target = this._armature.animation.getBlendState(
                      a.BONE_ALPHA,
                      f.name,
                      f
                    );
    ...
    r.prototype.addState = function (e, a) {
      ...
      if (a !== null) {
        for (var r = 0, i = a; r < i.length; r++) {
          ...
          switch (n.type) {
            case 40: {
              var s = t.BaseObject.borrowObject(
                t.AnimationProgressTimelineState
              );
              s.target = e;
  ...
  var n = (function (t) {
    ...
    e.prototype._onArriveAtFrame = function () {
      ...
      if (this._timelineData !== null) {
        ...
        var n =
          this._valueOffset + this._frameValueOffset + this._frameIndex * e;
        if (this._isTween) {
          var s =
            this._frameIndex === this._frameCount - 1
              ? this._valueOffset + this._frameValueOffset
            ...
            if (this._timelineArray !== null) {
              ...
              if (l) {
                ...
                while (p >= 0) {
                  var d =
                    this._animationData.frameOffset +
                    this._timelineArray[f.offset + 5 + p];
                  var y = this._frameArray[d] / this._frameRate;
                  if (
                    this._position <= y &&
                    y <= this._position + this._duration
                  ) {
...
(function (t) {
  var e = (function (e) {
    ...
    r.prototype._parsePathConstraint = function (e) {
      ...
      var n = i.getDisplay(
        a.name,
        r._getString(e, t.DataParser.TARGET_DISPLAY, a.name)
      );
      ...
      o.positionMode = t.DataParser._getPositionMode(
        r._getString(e, t.DataParser.POSITION_MODE, "")
      );
      o.spacingMode = t.DataParser._getSpacingMode(
        r._getString(e, t.DataParser.SPACING_MODE, "")
      );
      o.rotateMode = t.DataParser._getRotateMode(
        r._getString(e, t.DataParser.ROTATE_MODE, "")
      );
    ...
    r.prototype._parseSlot = function (e, a) {
      ...
      i.name = r._getString(e, t.DataParser.NAME, "");
      i.parent = this._armature.getBone(
        r._getString(e, t.DataParser.PARENT, "")
      );
      if (
        t.DataParser.BLEND_MODE in e &&
        typeof e[t.DataParser.BLEND_MODE] === "string"
      ) {
      ...
      if (t.DataParser.ACTIONS in e) {
        this._slotChildActions[i.name] = this._parseActionData(
    ...
    r.prototype._parseDisplay = function (e) {
      ...
      switch (n) {
        ...
        case 2: {
          ...
          d.geometry.inheritDeform = r._getBoolean(
            e,
    ...
    r.prototype._parseBoundingBox = function (e) {
      ...
      if (
        ...
        typeof e[t.DataParser.SUB_TYPE] === "string"
      ) {
    ...
    r.prototype._parseAnimation = function (e) {
      ...
      a.blendType = t.DataParser._getAnimationBlendType(
        r._getString(e, t.DataParser.BLEND_TYPE, "")
      );
    ...
    r.prototype._parseTimeline = function (e, i, n, s, o, l, h, u) {
      ...
      if (e !== null) {
        this._timelineArray[p + 0] = Math.round(
          r._getNumber(e, t.DataParser.SCALE, 1) * 100
        );
        this._timelineArray[p + 1] = Math.round(
          r._getNumber(e, t.DataParser.OFFSET, 0) * 100
        );
      } else {
      ...
      if (f === 1) {
        ...
        this._timelineArray[p + 5 + 0] =
          h.call(this, i[0], 0, 0) - this._animation.frameOffset;
      } else {
        ...
        for (var v = 0, g = 0, D = 0, T = 0; v < c; ++v) {
          if (D + T <= v && g < f) {
            ...
            this._timelineArray[p + 5 + g] =
              h.call(this, b, D, T) - this._animation.frameOffset;
            g++;
          }
          d[y + v] = g - 1;
        }
    ...
    r.prototype._parseTweenFrame = function (e, a, i) {
      ...
      if (i > 0) {
        if (t.DataParser.CURVE in e) {
          ...
          var o = this._samplingEasingCurve(
    ...
    r.prototype._parseSingleValueFrame = function (e, a, i) {
      ...
      switch (this._frameValueType) {
        case 0: {
          ...
          this._frameArray.length += 1;
          this._frameArray[n + 1] = r._getNumber(
            e,
            t.DataParser.VALUE,
        ...
        case 1: {
          ...
          this._frameIntArray[s] = Math.round(
            r._getNumber(e, t.DataParser.VALUE, this._frameDefaultValue) *
    ...
    r.prototype._parseDoubleValueFrame = function (e, a, i) {
      ...
      switch (this._frameValueType) {
        case 0: {
          ...
          this._frameArray[n + 2] = r._getNumber(
            e,
            t.DataParser.Y,
            this._frameDefaultValue
          );
        ...
        case 1: {
          ...
          this._frameIntArray[s] = Math.round(
            r._getNumber(e, t.DataParser.X, this._frameDefaultValue) *
              this._frameValueScale
          );
          this._frameIntArray[s + 1] = Math.round(
            r._getNumber(e, t.DataParser.Y, this._frameDefaultValue) *
              this._frameValueScale
          );
          break;
        }
    ...
    r.prototype._parseBoneRotateFrame = function (e, a, i) {
      ...
      this._frameFloatArray[o++] =
        r._getNumber(e, t.DataParser.SKEW, 0) * t.Transform.DEG_RAD;
      return s;
    };
    ...
    r.prototype._parseIKConstraintFrame = function (e, a, i) {
      ...
      var s = this._frameIntArray.length;
      this._frameIntArray.length += 2;
      this._frameIntArray[s++] = r._getBoolean(
        e,
        ...
        : 0;
      this._frameIntArray[s++] = Math.round(
        r._getNumber(e, t.DataParser.WEIGHT, 1) * 100
      );
      return n;
    };
      ...
      if (typeof e === "string") {
        ...
        for (var l = 0, h = e; l < h.length; l++) {
          ...
          if (t.DataParser.GOTO_AND_PLAY in u) {
            ...
            if (
              t.DataParser.TYPE in u &&
              typeof u[t.DataParser.TYPE] === "string"
            ) {
    ...
    r.prototype._parseDeformFrame = function (e, a, i) {
      ...
      if (a === 0) {
        ...
        this._timelineArray[this._timeline.offset + 3] =
          p - this._animation.frameIntOffset;
      }
      return s;
    };
    r.prototype._parseTransform = function (e, a, i) {
      ...
      if (t.DataParser.ROTATE in e || t.DataParser.SKEW in e) {
        a.rotation = t.Transform.normalizeRadian(
          r._getNumber(e, t.DataParser.ROTATE, 0) * t.Transform.DEG_RAD
        );
        a.skew = t.Transform.normalizeRadian(
          r._getNumber(e, t.DataParser.SKEW, 0) * t.Transform.DEG_RAD
        );
      } else if (t.DataParser.SKEW_X in e || t.DataParser.SKEW_Y in e) {
        a.rotation = t.Transform.normalizeRadian(
          r._getNumber(e, t.DataParser.SKEW_Y, 0) * t.Transform.DEG_RAD
        );
        a.skew =
          t.Transform.normalizeRadian(
            r._getNumber(e, t.DataParser.SKEW_X, 0) * t.Transform.DEG_RAD
          ) - a.rotation;
      }
    ...
    r.prototype._parseColorTransform = function (e, a) {
      a.alphaMultiplier =
        r._getNumber(e, t.DataParser.ALPHA_MULTIPLIER, 100) * 0.01;
      a.redMultiplier =
        r._getNumber(e, t.DataParser.RED_MULTIPLIER, 100) * 0.01;
      a.greenMultiplier =
        r._getNumber(e, t.DataParser.GREEN_MULTIPLIER, 100) * 0.01;
      a.blueMultiplier =
        r._getNumber(e, t.DataParser.BLUE_MULTIPLIER, 100) * 0.01;
    ...
    r.prototype.parseDragonBonesData = function (e, a) {
      ...
      if (
        t.DataParser.DATA_VERSIONS.indexOf(i) >= 0 ||
...
(function (t) {
  var e = (function (e) {
            ...
            f =
              this._frameArrayBuffer[
                this._animation.frameOffset +
                  this._timelineArrayBuffer[i.offset + 5 + u]
              ];
            if (u === n - 1) {
              ...
              _ =
                this._frameArrayBuffer[
                  this._animation.frameOffset +
                    this._timelineArrayBuffer[i.offset + 5 + u + 1]
                ] - f;
            }
            u++;
          }
    ...
    a.prototype._parseAnimation = function (e) {
      ...
      if (t.DataParser.Z_ORDER in e) {
        a.zOrderTimeline = this._parseBinaryTimeline(
          1,
          e[t.DataParser.Z_ORDER]
        );
      }
      ...
      if (this._displayIndex >= 0 && this._display !== null && e !== null) {
        ...
        if (r !== null) {
          if (this._geometryData !== null) {
            ...
            this._textureScale =
              e.parent.scale * this._armature._armatureData.scale;
  ...
  var e = (function (e) {
    ...
    a._clockHandler = function (t) {
      this._dragonBonesInstance.advanceTime(
        PIXI.ticker.shared.elapsedMS * t * 0.001
      );
    };
...
globalThis.dragonBones = dragonBones;
